        ...
        <ul class="nav navbar-nav side-nav">
            <li>
                ...
                <ul id="submenu-1" class="collapse">
                    <li><a href="/police?command=SEARCH_PAGE&status=missing"><i
                            class="fa fa-angle-double-right"></i> ${missing}</a></li>
                    <li><a href="/police?command=SEARCH_PAGE&status=wanted"><i
            ...
            <li><a href="/police?command=MANAGE_USER" class="menustyle">
                <i style="text-decoration: none" class="fa fa-users"></i> ${manageUser} </a>
            </li>

            <li><a class="menustyle" href="/police?command=MANAGE_DOC">
                <i style="text-decoration: none" class="fa fa-folder-open-o"></i> ${manageDoc} </a>
            </li>
            <li>
                <a href="/police?command=NEWS_PAGE"><i class="fa fa-newspaper-o"></i> ${news}</a>
            </li>
            <li>
